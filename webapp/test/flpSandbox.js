		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zsd041salesorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsd041salesorders-display": {
								"semanticObject": "zsd041salesorders",
								"action": "display",
								"description": "A Fiori application for making sales orders",
								"title": "Sales orders App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsd041salesorders",
									"url": sap.ui.require.toUrl("zsd041salesorders")
								}
							}
						}
					}
